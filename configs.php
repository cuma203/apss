 ...
 * @param   cscript_comressor_enabled   bool        Kompresja wyłączona/włączona: true | false
 */

$configs['cscript_compressor_enabled']                          = true;
 ...
 * @param   jscript_comressor_enabled   bool        Kompresja wĹ‚Ä…czona/wyĹ‚Ä…czona: true | false
 * @param   jscript_comressor_type      string      Nazwa moduĹ‚u kompresujÄ…cego kod JS: jShrink | JavaScriptPacker. 
 * Po wybraniu jShrink opcje: 'jscript_encoding', 'jscript_fast_decode', 'jscript_special_chars' nie majÄ… zastosowania.
 ...
 * @param   jscript_special_chars       bool        Kompresja z uwzglÄ™dnieniem znakĂłw specjalnych: true | false
 */
...
$configs['default_controller'] = "mainmenu";
...
$configs['files_catalog_name']          = "files";
...
$configs['modules_path']                = "application".DS."modules".DS;
...
$configs['app_files_path']              = "application".DS."media".DS.$configs['files_catalog_name'].DS;
